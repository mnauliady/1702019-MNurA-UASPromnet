			...
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						...
						<a href="<?php echo site_url('C_karyawan/join'); ?>" class="btn btn-success"> <span>Hasil Join</span></a>
					</div>
				</div>
			</div>
					...
					<tr>
						...
						foreach ($karyawan as $key) {
							...
							<td>
								...
								<a href="#editEmployeeModal<?php echo $key->id;?>" class="delete" data-toggle="modal">Update</a>
							</td>
						</tr>
						<?php
						$i++;
